    ...
    <div class="col-md-8">
        ...
        <div class="card shadow">
            <div class="card-header bg-warning">
                <h4 class="mb-0">
                    <i class="bi bi-pencil"></i> Edit Product: <?= htmlspecialchars($product->name) ?>
                </h4>
            </div>
            <div class="card-body">
                <?php 
                ...
                <form action="/products/<?= $product->id ?>" method="POST" id="productForm" novalidate>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="number" 
                                   ...
                                   value="<?= htmlspecialchars($old['quantity_available'] ?? $product->quantityAvailable) ?>"
                                   min="0"
                                   required>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="url" 
                               ...
                               id="image_url" 
                               name="image_url" 
                               value="<?= htmlspecialchars($old['image_url'] ?? $product->imageUrl ?? '') ?>"
                    ...
                    <div class="mb-3">
                        <div class="form-check form-switch">
                            ...
                            <input class="form-check-input" 
                                   ...
                                   name="is_active" 
                                   value="1"
                                   <?= ($old['is_active'] ?? $product->isActive) ? 'checked' : '' ?>>
